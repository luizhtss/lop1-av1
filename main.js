...
salario_bruto = parseFloat(prompt("Entre com um salário bruto: "))
...
if(salario_bruto<=1100){
    ...
    salario_liquido = salario_bruto - d 
    ...
    d = ((2203.48 - 1100.01) * (9 / 100)) + ((salario_bruto * (7.5 / 100)) + ((3305.22 - 2203.49) * (12 / 100)) + ((6433.57 - 3305.23 ) * (14 / 100)))
    if(d >= 828.39){
        salario_liquido = salario_bruto - 828.39
    }else{
        salario_liquido = salario_bruto - d
    }
}else{
...
if(salario_liquido >= 1903.99 && salario_liquido <= 2826.65){
    ...
    d = (salario_liquido * (7.5 / 100))
    salario_liquido = salario_liquido - d
    ...
    d = ((2826.65 - 1903.99 ) * (7.5 / 100)) + ((3751.05 - 2826.66 ) * (15 / 100)) + ((4664.68 - 3751.06 ) * (22.5 / 100)) +  ((salario_liquido - 4664.68) * (27.5 / 100))
    salario_liquido = salario_liquido - d
}
